...
async function sendImageAsSticker2(nyx, from, buffer, quoted, metadata = {}) {
    try {
        ...
        await nyx.sendMessage(from, { sticker: finalBuffer }, { quoted })
...
async function sendVideoAsSticker2(nyx, from, buffer, quoted, metadata = {}) {
    try {
        const packname = metadata.packname || "Sticker Bot"
        const author = metadata.author || "WhatsApp Bot"
        const mode = metadata.mode || 'normal'
